        ...
        <div className="flex flex-col gap-3">
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <span className="text-base font-semibold text-neutral-900">{FEATURED_ACTION.label}</span>
              <p className="text-sm text-neutral-500">Solo cambia el número y la fecha</p>
            </div>
          </Link>
